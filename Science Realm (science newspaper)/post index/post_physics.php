...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img/img post/physics-bg.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Physics</h1>
                            <span class="subheading">Physicists have come to realize that mathematics, when used with sufficient care, is a proven pathway to truth.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            $statement = $db->query("SELECT * 
                                    FROM post WHERE post.category1=2 OR post.category2=2 OR post.category3=2 OR post.category4=2 OR post.category5=2 OR post.category6=2
