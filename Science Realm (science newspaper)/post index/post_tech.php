...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img/img post/tech-bg.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Technology</h1>
                            <span class="subheading">The advance of technology is based on making it fit in so that you don't really even notice it, so it's part of everyday life.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            $statement = $db->query("SELECT * 
                                    FROM post WHERE post.category1=5 OR post.category2=5 OR post.category3=5 OR post.category4=5 OR post.category5=5 OR post.category6=5
