...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img/img post/math-bg.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Mathematics</h1>
                            <span class="subheading">Pure mathematics is, in its way, the poetry of logical ideas.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            $statement = $db->query("SELECT * 
                                    FROM post WHERE post.category1=1 OR post.category2=1 OR post.category3=1 OR post.category4=1 OR post.category5=1 OR post.category6=1
