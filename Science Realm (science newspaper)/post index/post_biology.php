...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img/img post/biology-bg.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Biology</h1>
                            <span class="subheading">There's biology in everything, even when you're feeling spiritual.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            $statement = $db->query("SELECT * 
                                    FROM post WHERE post.category1=4 OR post.category2=4 OR post.category3=4 OR post.category4=4 OR post.category5=4 OR post.category6=4
