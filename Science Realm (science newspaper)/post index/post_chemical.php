...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('../assets/img/img post/chemical-bg.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Chemical</h1>
                            <span class="subheading">Feelings are like chemicals, the more you analyze them the worse they smell.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php
            ...
            $statement = $db->query("SELECT * 
                                    FROM post WHERE post.category1=3 OR post.category2=3 OR post.category3=3 OR post.category4=3 OR post.category5=3 OR post.category6=3
