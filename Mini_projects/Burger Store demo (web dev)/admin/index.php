                    ...
                    <tbody>
                        <?php
                            ...
                            while ($item = $statement->fetch()){
                                ...
                                echo '<td>'.number_format((float)$item['price'], 2, '.', NULL).'</td>';
                                echo '<td>'.$item['category'].'</td>';
                                echo '<td width=340>';
                                    echo '<a class="btn btn-default" href="view.php?id='.$item['id'].'" ><span class="bi-eye"></span> Voir</a>';
                                    echo '<a> </a>';
